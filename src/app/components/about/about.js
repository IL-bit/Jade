        ...
        <div className="container-fluid">
            ...
            <div className="row" id="about">
                <div className="col-sm-12">
                    ...
                    <p className="first">Бренд, вдохновленный французским<br/>стилем, понимет, какими женщины<br/>являются сейчас и какими они хотят<br/>быть завтра. Jadé позволяет мне чувствовать себя увереннее, я могу<br/>самостоятельно решать как вести<br/>себя и как выглядеть.</p>
